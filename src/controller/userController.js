...
const vaccineResistration = async (req, res) => {
    try {
        let user = req.user;
...
const updateResister = async (req, res) => {
    try {
...
module.exports = { userResister, userLogin, getTimeSlots, vaccineResistration, updateResister }